local Activity_CommercialHoliday_Page = {}
Activity_CommercialHoliday_Page.activityData = nil

function Activity_CommercialHoliday_Page:Init()
  self:InitControls()
end

function Activity_CommercialHoliday_Page:InitControls()
...
function Activity_CommercialHoliday_Page:Refresh(data, ui)
  self.lab_name:SetText(data.commerceName)
  self.img_clickeffect:SetActive(data.Selected)
  self.img_redPoint:SetActive(RedPointChecker_Ext:GetTogHolidayRedPoint(CommerceHolidayRedTogType[data.group]))
...
function Activity_CommercialHoliday_Page:RefreshCtrName()
...
function Activity_CommercialHoliday_Page:GetRedPointPath()
  return self.basePanel.root.gameObject.name .. "#" .. self:UIControl().gameObject.name
end

function Activity_CommercialHoliday_Page:SetClickEffect(isActive)
  self.img_clickeffect:SetActive(isActive)
end

function Activity_CommercialHoliday_Page:BindRedPoint()
...
function Activity_CommercialHoliday_Page:RemoveCacheRedPoint(checkSameRedPoint)
...
function Activity_CommercialHoliday_Page:Exit()
  self:RemoveCacheRedPoint()
end

return Activity_CommercialHoliday_Page
