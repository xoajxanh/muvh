local BossUI_HolySkeletonBossTemp = {}

function BossUI_HolySkeletonBossTemp:Init()
  self:InitControl()
  self:InitContainer()
end

function BossUI_HolySkeletonBossTemp:InitControl()
...
function BossUI_HolySkeletonBossTemp:InitContainer()
  self.mapItemTemp = UIContainer(self.mapItem, self, OnMapItemCreate)
  self.bossMapTab = {}
end

function BossUI_HolySkeletonBossTemp:SetDefaultSelectedBossIndex()
  local bossData = MonsterData.FilterSameBossId(MonsterData.GetMonsterBossType(MonsterBossType.HolySkeletonBoss, true))
  self.bossDataList = {}
...
function BossUI_HolySkeletonBossTemp:RefreshBossTableView()
...
function BossUI_HolySkeletonBossTemp:UpdateWildCellCallBack(index)
...
function BossUI_HolySkeletonBossTemp:RefreshLeftView(bossConfig, obj, index)
  ...
  if monsterBossCanKill then
    ...
    obj.lab_openLevel:SetText(bossConfig.Displaylevel)
  end
...
function BossUI_HolySkeletonBossTemp:RefreshRightView(obj, bossConfig)
  ...
  local str = "Ti\195\170u di\225\187\135t" .. " " .. name
  self.sl_BossName:SetText(str)
...
function BossUI_HolySkeletonBossTemp:RefreshShBossReward(bossConfig)
...
function BossUI_HolySkeletonBossTemp:SetMapOnClick(mapID)
...
function BossUI_HolySkeletonBossTemp:Refresh(baseUI)
  if baseUI ~= nil then
    self.baseUI = baseUI
  end
...
return BossUI_HolySkeletonBossTemp
