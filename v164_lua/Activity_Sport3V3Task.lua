...
function Activity_Sport3V3Task:InitControls()
  ...
  self.txt_title = self:GetControl("panel/subPanel/TaskPanel/Normal3v3Task/txt_title")
end
...
function Activity_Sport3V3Task:Refresh()
  ...
  local title = not QuickFind:GetThreeVsThreeDataMgr():IsInActivity() and "\196\144\225\187\153i Qu\195\161n Qu\195\162n" or "3V3 \195\129c Chi\225\186\191n"
  self.txt_title:SetText(title or "3V3 \195\129c Chi\225\186\191n")
