...
function Main_MainMenuUI:InitControls()
  ...
  self.btn_team3V3 = self:GetControl("go_right_top/go_activity/btn_team3V3")
end
...
function Main_MainMenuUI:RegistUIEvents()
  ...
  self.btn_team3V3:SetOnClick(self, self.btn_team3V3OnClick)
end

function Main_MainMenuUI:btn_team3V3OnClick(control)
  networkRequest.ReqGetMatchTeamInfo(0, ReqTeamInfoType.Default)
  local teamInfo = QuickFind:GetTeam3V3DataMgr():GetMatchTeamInfo()
  if teamInfo.enemyTeamId and teamInfo.enemyTeamId ~= 0 then
    networkRequest.ReqGetMatchTeamInfo(teamInfo.enemyTeamId, ReqTeamInfoType.Default)
  end
...
function Main_MainMenuUI:NewBtn_shrinkOnClick()
  ...
  self:RefreshFoldButtonRedPointEff()
...
function Main_MainMenuUI:RefreshFoldButtonRedPointEff()
  self.btn_team3V3:GetChild("Eff_UI_anniutishi05"):SetActive(self.activityState)
end
...
function Main_MainMenuUI:TimeAcrossDayCallBack()
  self:RefreshTimeLimitedActivitiesShowState()
  EventManager.Dispatch(Event.Fuc_SingleRefresh, {5400001})
end
...
function Main_MainMenuUI:Refresh()
  ...
  self:RefreshActivityBtnImage()
  QuickFind:GetTeam3V3DataMgr():CheckCanLiu()
end
