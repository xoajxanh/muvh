...
function _getter.darkRed()
  return Color.New(0.9, 0.2, 0.1, 1)
end
...
function _getter.blue()
  return Color.New(0.168627, 0.741176, 1, 1)
end
...
function _getter.orange()
  return Color.New(1, 0.7529412, 0, 1)
end

function _getter.pink()
  return Color.New(0.8509804, 0.08627451, 0.8509804, 1)
end

function _getter.purple()
  return Color.New(0.831372, 0.13725, 0.7215686, 1)
end

function _getter.gold()
  return Color.New(0.952941, 0.54901, 0, 1)
end

function _getter.paleGold()
  return Color.New(1, 0.764705, 0.117647, 1)
end

function _getter.paleYellow()
  return Color.New(1, 0.85, 0.58, 1)
end

function _getter.orangeRed()
  return Color.New(1, 0.2705882, 0, 1)
end
