...
& $adbExe -s emulator-5562 shell "rm -f /storage/emulated/0/Android/data/com.vnyh.gp/files/output.txt"
& $adbExe -s emulator-5562 push $tempLuac $androidPath
...
& $adbExe -s emulator-5562 pull "/storage/emulated/0/Android/data/com.vnyh.gp/files/output.txt" "$testDir\output.txt"
