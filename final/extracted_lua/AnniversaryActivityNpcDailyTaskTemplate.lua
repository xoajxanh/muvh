local AnniversaryActivityNpcDailyTaskTemplate = {}

function AnniversaryActivityNpcDailyTaskTemplate:Init()
  self:InitControls()
  self:RegistUIEvents()
end

function AnniversaryActivityNpcDailyTaskTemplate:InitControls()
...
function AnniversaryActivityNpcDailyTaskTemplate:RegistUIEvents()
  self.btn_go:SetOnClick(self, self.btn_goOnClick)
  self.btn_get:SetOnClick(self, self.btn_getOnClick)
end

function AnniversaryActivityNpcDailyTaskTemplate:btn_goOnClick(control)
  AnniversaryActivityController.GoTask(self.data)
end

function AnniversaryActivityNpcDailyTaskTemplate:btn_getOnClick(control)
end

function AnniversaryActivityNpcDailyTaskTemplate:Refresh(data, ui)
  self.data = data
...
function AnniversaryActivityNpcDailyTaskTemplate:SetTaskState(state)
...
return AnniversaryActivityNpcDailyTaskTemplate
