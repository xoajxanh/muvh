...
_G.Mod_RestartAllBackgroundLoops = function()
    ...
    if _G.Mod_FindHoaLong_Enabled and _G.Mod_StartFindHoaLongLoop then pcall(_G.Mod_StartFindHoaLongLoop) end
end
...
_G.Mod_DoSystemFreshCleanup = function()
    pcall(function()
        ...
        if _G.ModUpdateFindHoaLongLabel then pcall(_G.ModUpdateFindHoaLongLabel) end
...
local function CreateModUI()
    local status, err = pcall(function()
        ...
        local function GetPlayerReincarnationLevel()
            local level = 8
            pcall(function()
                if _G.RoleManager and _G.RoleManager.me and _G.RoleManager.me.data then
                    local d = _G.RoleManager.me.data
                    if d.zhuanshengLevel and d.zhuanshengLevel > 0 then
                        level = d.zhuanshengLevel
                    elseif d.changeLifeLevel and d.changeLifeLevel > 0 then
                        level = d.changeLifeLevel
                    end
                end
            end)
            return level
        ...
        local function GetKundunTiers()
            ...
            if #tiers == 0 then
                table.insert(tiers, "C7")
                table.insert(tiers, "C8")
            end
            return tiers
        end
        ...
        -- =========================================================================
        -- 1. Cấu hình Chuẩn & Đa Vị Trí (Dành cho Auto Boss & Tab Thông Tin Boss C3-C12)
        ...
        _G.Mod_MapsConfig_c5 = {
            {
                ...
                title = "Hoang Dã C5",
                bosses = {
                    { id = 10179507, name = "Giác Ma Đ.Ngục", col = 1, posX = 128, posY = 166, spots = { { x = 128, y = 166 }, { x = 153, y = 229 } }, useCallFlag = true },
                    { id = 10179508, name = "Phẫn Nộ", col = 2, posX = 87, posY = 234, spots = { { x = 87, y = 234 }, { x = 87, y = 187 } }, useCallFlag = true },
                    { id = 10179509, name = "Cuồng Bạo", col = 3, posX = 56, posY = 234, spots = { { x = 56, y = 234 }, { x = 43, y = 182 } }, useCallFlag = true },
                }
            },
            {
                mapId = 105205,
                ...
                bosses = {
                    ...
                    { id = 999105205, name = "[ THOÁT PB ]", col = 3, isExitBtn = true },
                }
            },
            {
                mapId = 106404,
            ...
            },
            {
                ...
                title = "Luyện Ngục C5",
                bosses = {
                    { id = 10670201, name = "Nars", col = 1, transferId = 106702101, transferIds = { 106702101, 106702102 } },
                    { id = 10670202, name = "Ngang Ngược", col = 2, transferId = 106702103, transferIds = { 106702103, 106702104 } },
        ...
        _G.Mod_MapsConfig_c6 = {
            {
                ...
                title = "Hoang Dã C6",
                bosses = {
                    { id = 10179207, name = "V.Sĩ Khiên Kiếm", col = 1, posX = 107, posY = 92, spots = { { x = 107, y = 92 }, { x = 82, y = 140 } }, useCallFlag = true },
                    { id = 10179208, name = "Phẫn Nộ", col = 2, posX = 151, posY = 121, spots = { { x = 151, y = 121 }, { x = 107, y = 175 } }, useCallFlag = true },
                    { id = 10179209, name = "Cuồng Bạo", col = 3, posX = 181, posY = 121, spots = { { x = 181, y = 121 }, { x = 182, y = 174 } }, useCallFlag = true },
                }
            },
            {
                mapId = 105206,
                ...
                bosses = {
                    ...
                    { id = 999105206, name = "[ THOÁT PB ]", col = 3, isExitBtn = true },
                }
            },
            {
                mapId = 106405,
        ...
        _G.Mod_MapsConfig_c7 = {
            {
                ...
                title = "Hoang Dã C7",
                bosses = {
                    { id = 10179607, name = "Tektus", col = 1, posX = 101, posY = 108, spots = { { x = 101, y = 108 }, { x = 15, y = 87 } }, useCallFlag = true },
                    { id = 10179608, name = "Phẫn Nộ", col = 2, posX = 36, posY = 148, spots = { { x = 36, y = 148 }, { x = 141, y = 164 } }, useCallFlag = true },
                    { id = 10179609, name = "Cuồng Bạo", col = 3, posX = 142, posY = 241, spots = { { x = 142, y = 241 }, { x = 99, y = 241 } }, useCallFlag = true },
                }
            },
            {
                mapId = 105207,
        ...
        _G.Mod_MapsConfig_c8 = {
            {
                ...
                title = "Hoang Dã C8",
                bosses = {
                    { id = 107407, name = "K.Sĩ Tử Vong", col = 1, posX = 236, posY = 219, spots = { { x = 236, y = 219 }, { x = 127, y = 217 } }, useCallFlag = true },
                    { id = 107408, name = "Phẫn Nộ", col = 2, posX = 210, posY = 113, spots = { { x = 210, y = 113 }, { x = 188, y = 73 } }, useCallFlag = true },
                    { id = 107409, name = "Cuồng Bạo", col = 3, posX = 123, posY = 13, spots = { { x = 123, y = 13 }, { x = 60, y = 55 } }, useCallFlag = true },
                }
            },
            {
                mapId = 105208,
        ...
        _G.Mod_MapsConfig_c9 = {
            {
                ...
                title = "Hoang Dã C9",
                bosses = {
                    { id = 107507, name = "S.Giả Ác Ma", col = 1, posX = 157, posY = 179, spots = { { x = 157, y = 179 }, { x = 188, y = 169 } }, useCallFlag = true },
                    { id = 107508, name = "Phẫn Nộ", col = 2, posX = 64, posY = 86, spots = { { x = 64, y = 86 }, { x = 32, y = 61 } }, useCallFlag = true },
                    { id = 107509, name = "Cuồng Bạo", col = 3, posX = 15, posY = 45, spots = { { x = 15, y = 45 }, { x = 189, y = 68 } }, useCallFlag = true },
                }
            },
            {
                mapId = 105209,
                ...
                bosses = {
                    ...
                    { id = 999105209, name = "[ THOÁT PB ]", col = 3, isExitBtn = true },
                }
            },
            {
                mapId = 106408,
        ...
        _G.Mod_MapsConfig_c10 = {
            {
                ...
                title = "Hoang Dã C10",
                bosses = {
                    { id = 107607, name = "C.Sĩ Cuồng Nộ", col = 1, posX = 31, posY = 224, spots = { { x = 31, y = 224 }, { x = 195, y = 180 } }, useCallFlag = true },
                    { id = 107608, name = "Phẫn Nộ", col = 2, posX = 216, posY = 192, spots = { { x = 216, y = 192 }, { x = 160, y = 76 } }, useCallFlag = true },
                    { id = 107609, name = "Cuồng Bạo", col = 3, posX = 129, posY = 26, spots = { { x = 129, y = 26 }, { x = 63, y = 72 } }, useCallFlag = true },
                }
            },
            {
                mapId = 105210,
                ...
                bosses = {
                    ...
                    { id = 999105210, name = "[ THOÁT PB ]", col = 3, isExitBtn = true },
                }
            },
            {
                mapId = 106409,
        ...
        _G.Mod_MapsConfig_c11 = {
            {
                ...
                title = "Hoang Dã C11",
                bosses = {
                    { id = 1012307, name = "Thủy Ma Navos", col = 1, posX = 124, posY = 224, spots = { { x = 124, y = 224 }, { x = 48, y = 221 } }, useCallFlag = true },
                    { id = 1012308, name = "Phẫn Nộ", col = 2, posX = 218, posY = 222, spots = { { x = 218, y = 222 }, { x = 223, y = 52 } }, useCallFlag = true },
                    { id = 1012309, name = "Cuồng Bạo", col = 3, posX = 25, posY = 10, spots = { { x = 25, y = 10 }, { x = 127, y = 16 } }, useCallFlag = true },
                }
            },
            {
                mapId = 105211,
                ...
                bosses = {
                    ...
                    { id = 999105211, name = "[ THOÁT PB ]", col = 3, isExitBtn = true },
                }
            },
            {
                mapId = 106410,
        ...
        _G.Mod_MapsConfig_c12 = {
            {
                ...
                title = "Hoang Dã C12",
                bosses = {
                    { id = 101230107, name = "Thần Hắc Ám", col = 1, posX = 124, posY = 224, spots = { { x = 124, y = 224 }, { x = 48, y = 221 } }, useCallFlag = true },
                    { id = 101230108, name = "Phẫn Nộ", col = 2, posX = 218, posY = 222, spots = { { x = 218, y = 222 }, { x = 223, y = 52 } }, useCallFlag = true },
                    { id = 101230109, name = "Cuồng Bạo", col = 3, posX = 25, posY = 10, spots = { { x = 25, y = 10 }, { x = 127, y = 16 } }, useCallFlag = true },
                }
            },
            {
                mapId = 105212,
                ...
                bosses = {
                    ...
                    { id = 999105212, name = "[ THOÁT PB ]", col = 3, isExitBtn = true },
                }
            },
            {
                mapId = 106411,
        ...
        local function GetBossWatcherConfigByTier(tierTag)
            return GetMapsConfigByTier(tierTag)
        end
        ...
        local function GetLineButton(btnIndex, posX, posY, width, height)
            ...
            btnUIPool[btnIndex].img.raycastTarget = true
        ...
        local function UpdateBossWatchUIText()
            pcall(function()
                ...
                local function TeleportToBossSpot(mapCfg, cfg, spotIndex, validLineNum)
                    ...
                    local spotIdx = spotIndex or 1
                    local targetX, targetY = nil, nil
                    if cfg.spots and cfg.spots[spotIdx] then
                        targetX = cfg.spots[spotIdx].x
                        targetY = cfg.spots[spotIdx].y
                    elseif cfg.posX and cfg.posY then
                        targetX = cfg.posX
                        targetY = cfg.posY
                    end

                    local targetTransferId = nil
                    if cfg.transferIds and cfg.transferIds[spotIdx] then
                        targetTransferId = cfg.transferIds[spotIdx]
                    elseif cfg.transferId then
                        targetTransferId = cfg.transferId
                    end

                    if cfg.useCallFlag and targetX and targetY then
                        if _G.NetManager and _G.MapMessage and _G.MapMessage.ReqCallFlag then
                            ...
                            if _G.FloatingWordUtility then
                                _G.FloatingWordUtility.QuickMsg(string.format("Đang bay tới %s (Boss %d: %d, %d)", tostring(cfg.name), spotIdx, targetX, targetY))
                            end
                        end
                ...
                for i, mapCfg in ipairs(mapsConfig) do
                    ...
                    for r = 1, maxRows do
                        local rowHasSubButtons = false
                        for c = 1, 3 do
                            local cfg = colBosses[c][r]
                            if cfg and not cfg.isExitBtn then
                                local numSub = math.max(#(cfg.spots or {}), #(cfg.transferIds or {}))
                                if numSub >= 2 then
                                    rowHasSubButtons = true
                                end
                            end
                        end
                        ...
                        for c = 1, 3 do
                            ...
                            if cfg then
                                ...
                                local yPos = currentPosY

                                if cfg.isExitBtn then
                                    local bw = 155
                                    local uiBtn = GetLineButton(btnIdx, startX, yPos, bw, 26)
                                    ...
                                    -- Dòng 1: Tên Boss + Trạng thái (Nếu boss có >= 2 vị trí thì không click dòng này)
                                    local uiBtn = GetLineButton(btnIdx, startX, yPos, 215, 22)
                                    uiBtn.go:SetActive(_G.ModMainTab == "CO_BAN")
                                    uiBtn.img.color = CS.UnityEngine.Color(1, 1, 1, 0)
                                    ...
                                    if numSub >= 2 then
                                        uiBtn.img.raycastTarget = false
                                    else
                                        uiBtn.img.raycastTarget = true
                                        local thisCfg = cfg
                                        local thisMapCfg = mapCfg
                                        local thisLine = validLineNum
                                        uiBtn.btn.onClick:AddListener(function()
                                            TeleportToBossSpot(thisMapCfg, thisCfg, 1, thisLine)
                                        end)
                                    end
                                    btnIdx = btnIdx + 1

                                    -- Dòng 2: Cụm nút [ Boss 1 ] [ Boss 2 ] không nền, khoảng cách chuẩn
                                    if numSub >= 2 then
                                        local subBtnW = 75
                                        local subSpacing = 10
                                        for sIdx = 1, numSub do
                                            local subX = startX + (sIdx - 1) * (subBtnW + subSpacing)
                                            local subBtn = GetLineButton(btnIdx, subX, yPos - 22, subBtnW, 20)
                                            subBtn.go:SetActive(_G.ModMainTab == "CO_BAN")
                                            subBtn.img.color = CS.UnityEngine.Color(1, 1, 1, 0) -- Bỏ nền xám
                                            subBtn.img.raycastTarget = true
                                            subBtn.txt.text = string.format("<color=#FFCC00>[ Boss %d ]</color>", sIdx)
                                            subBtn.txt.fontSize = 15
                                            subBtn.txt.alignment = TextAnchor.MiddleLeft
                                            subBtn.btn.onClick:RemoveAllListeners()
                                            local thisSpotIdx = sIdx
                                            local thisCfg = cfg
                                            local thisMapCfg = mapCfg
                                            local thisLine = validLineNum
                                            subBtn.btn.onClick:AddListener(function()
                                                TeleportToBossSpot(thisMapCfg, thisCfg, thisSpotIdx, thisLine)
                                            end)
                                            btnIdx = btnIdx + 1
                                        end
                                    end
                        ...
                        if rowHasSubButtons then
                            currentPosY = currentPosY - 46
                        else
                            currentPosY = currentPosY - 24
                        end
                    end
        ...
        if not _G.BossHooked then
            ...
            if original_InitFinalAttribute and not _G.ModMeDataAtkSpeedHooked then
                ...
                _G.MeData.InitFinalAttribute = function(self)
                    ...
                    if (_G.Mod_IsActive and _G.Mod_IsActive()) and _G.AtkSpeedMultiplier and _G.AtkSpeedMultiplier > 1.0 then
                ...
                local status, err = pcall(function()
                            ...
                            if monsterRoles then
                                for lid, role in pairs(monsterRoles) do
                                    ...
                                    if mId and role.hp and role.hp > 0 then
                                        ...
                                        if GetAvailableTiers then
                                            for _, tTag in ipairs(GetAvailableTiers()) do
                                                foundCombatBoss = CheckList(GetMapsConfigByTier(tTag))
                    ...
                    elseif _G.Mod_AutoFarmBoss_State == 2 then
                        ...
                        if #candidates > 0 then
                            ...
                            if GetAvailableTiers then
                                for _, tTag in ipairs(GetAvailableTiers()) do
                                    DebugConfig(GetMapsConfigByTier(tTag))
                                end
                            end
                        end
                            ...
                            if isAdminBurst and nearestItem and _G.RoleManager and _G.RoleManager.me then
                                if nearestItem.id ~= _G.Mod_AdminLastTargetMove or (nowTime - (_G.Mod_AdminLastMoveTime or 0)) > 0.3 then
                                    ...
                                    pcall(function()
                                        ...
                                        if me.MoveTo and nearestItem.x and nearestItem.y then
                                            me:MoveTo({ x = nearestItem.x, y = nearestItem.y }, 0)
                                        end
                                    end)
                                end
                            end
            ...
            _G.Mod_StartBossAutoRefreshLoop()
                    ...
                    local function IsSelfBuffOrNoTargetSkill(skillId)
                        ...
                        local noTargetGroupIds = {
                            [10200300] = true, -- Thiên Sứ Giáng Thế
                            [10100400] = true, -- Cuồng Bạo Tê Liệt / Tê Liệt Cuồng Nộ
                            [10300300] = true, -- Thuật Hộ Thể / Ma Lực Hộ Thuẫn
                            [10400400] = true, -- Tiễn Vũ / Tụ Lực Tiễn
                            [10500400] = true, -- Ma Quang Phá
                            [10600400] = true, -- Ảo Ảnh Phân Thân
                        }
                        local sIdNum = tonumber(skillId) or 0
                        local sGroup = math.floor(sIdNum / 100) * 100
                        if noTargetGroupIds[sGroup] or noTargetGroupIds[sIdNum] then
                            return true
                        end
                        return false
                    end

                    -- Hook RoleTargetManager để áp dụng bộ lọc bảo hộ và khóa mục tiêu đa điều kiện
                    if _G.RoleTargetManager and not _G.Mod_HookedRoleTargetManager then
                    ...
                    -- Hook Main_MainSkillUI: Khi bấm kỹ năng tấn công, nếu bật Khóa Mục Tiêu thì bắt buộc tìm/ép đúng mục tiêu đã khóa
                    if _G.Main_MainSkillUI and not _G.Mod_HookedMainSkillUI then
                        _G.Mod_HookedMainSkillUI = true
                    ...
                    _G.Mod_StartPKScanLoop()
                end

                -- =========================================================================
                -- [MOD FEATURE]: TỰ QUAY LẠI TỌA ĐỘ TRAIN (AUTO RETURN POSITION LOOP)
                                    ...
                                    if sx and sy then
                                        ...
                                        if me and not me.isDead then
                                            ...
                                            if curX > 0 and curY > 0 then
                                                local dist = math.max(math.abs(curX - targetX), math.abs(curY - targetY))
                                                if dist > 1.5 then
                                                        ...
                                                        pcall(function()
                                                            ...
                                                            elseif _G.PathFinderManager and _G.PathFinderManager.JumpMapToMoveToPos and _G.SceneData and _G.SceneData.groupId then
                                                                ...
                                                                _G.PathFinderManager.JumpMapToMoveToPos(
                                                                    ...
                                                                    _G.Purpose and _G.Purpose.None or 0, nil, 1, true)
                                                            end
                                                        end)
                                                    end
                                                else
        ...
        _G.Mod_IsActive = function()
            ...
            if (now - _lastAuthCheckTime) > 1.0 then
                _lastAuthCheckTime = now
                local tokenSaved = CS.UnityEngine.PlayerPrefs.GetString("Mod_AuthToken", "")
                _cachedAuthResult = _G.CheckModAuth and _G.CheckModAuth(tokenSaved, true) or false
            end
        ...
        _G.Mod_ClearAuthToken = function()
            pcall(function()
                local modKeys = {
                    ...
                    "Mod_TeleNotify_Enabled", "Mod_AutoBoss_SkipHpPct"
                }
                ...
                local fumoSlots = { "Mu", "Quan", "Ao", "Tay", "Giay", "VKChinh", "VKPhu" }
                for _, slot in ipairs(fumoSlots) do
                    for lv = 1, 7 do
                        CS.UnityEngine.PlayerPrefs.DeleteKey("Mod_AutoPick_Fumo_" .. slot .. "_LV" .. lv)
                        _G["AutoPick_Fumo_" .. slot .. "_LV" .. lv] = false
                    end
                end
                ...
                if _G.authPanelGo then
                    local inputField = _G.authPanelGo.transform:Find("AuthTokenInput")
                    if inputField then
                        local inp = inputField:GetComponent(typeof(CS.UnityEngine.UI.InputField))
        ...
        local function CreateAuthUI()
            ...
            authRt.sizeDelta = Vector2(600, 480)
            ...
            local function Base64Decode(data)
                ...
                local status, res = pcall(function()
                    local bytes = CS.System.Convert.FromBase64String(data)
                    return CS.System.Text.Encoding.UTF8:GetString(bytes)
                end)
                if status and res and res ~= "" then return res end

                local status2, res2 = pcall(function()
            ...
            -- 1. Device Code Section (Input Field for manual selection/copy)
            ...
            local codeInputField = codeGo:AddComponent(typeof(CS.UnityEngine.UI.InputField))
            ...
            -- 2. Character UID Section (Input Field for manual selection/copy)
            local uidLblGo = GameObject("AuthUidLbl")
            uidLblGo.transform:SetParent(authPanelGo.transform, false)
            ...
            uidLblRt.anchoredPosition = Vector2(20, -135)
            uidLblRt.sizeDelta = Vector2(400, 20)
            local uidLblTxt = uidLblGo:AddComponent(typeof(Text))
            uidLblTxt.text = "Mã UID nhân vật:"
            uidLblTxt.color, uidLblTxt.fontSize = Color.white, 16
            if defaultFont then uidLblTxt.font = defaultFont end

            local uidGo = GameObject("AuthUidInput")
            ...
            uidRt.anchoredPosition = Vector2(20, -155)
            uidRt.sizeDelta = Vector2(425, 35)
            local uidImg = uidGo:AddComponent(typeof(Image))
            uidImg.color = Color(1, 1, 1, 1)

            local uTextGo = GameObject("Text")
            uTextGo.transform:SetParent(uidGo.transform, false)
            local uTxtRt = uTextGo:AddComponent(typeof(RectTransform))
            uTxtRt.anchorMin, uTxtRt.anchorMax = Vector2(0, 0), Vector2(1, 1)
            uTxtRt.offsetMin, uTxtRt.offsetMax = Vector2(5, 0), Vector2(-5, 0)
            local uidTxt = uTextGo:AddComponent(typeof(Text))
            local curUID = Mod_GetCharacterUID()
            local initUidVal = (curUID ~= "" and curUID or "Chưa đăng nhập nhân vật")
            uidTxt.text = initUidVal
            uidTxt.color, uidTxt.fontSize = Color.black, 16
            uidTxt.alignment = TextAnchor.MiddleLeft
            if defaultFont then uidTxt.font = defaultFont end

            local uidInputField = uidGo:AddComponent(typeof(CS.UnityEngine.UI.InputField))
            uidInputField.textComponent = uidTxt
            uidInputField.text = initUidVal
            ...
            copyUidRt.anchoredPosition = Vector2(-20, -155)
            ...
            cuTxt.text = "Copy UID"
            cuTxt.color, cuTxt.fontSize, cuTxt.alignment = Color.white, 16, TextAnchor.MiddleCenter
            ...
            tokenLblRt.anchoredPosition = Vector2(20, -205)
            ...
            tokenRt.anchoredPosition = Vector2(20, -225)
            tokenRt.sizeDelta = Vector2(330, 35)
            ...
            pasteRt.anchoredPosition = Vector2(-130, -225)
            pasteRt.sizeDelta = Vector2(100, 35)
            ...
            pTxt.color, pTxt.fontSize, pTxt.alignment = Color.white, 14, TextAnchor.MiddleCenter
            ...
            local clearBtnGo = GameObject("AuthClearBtn")
            clearBtnGo.transform:SetParent(authPanelGo.transform, false)
            local clearRt = clearBtnGo:AddComponent(typeof(RectTransform))
            clearRt.anchorMin, clearRt.anchorMax, clearRt.pivot = Vector2(1, 1), Vector2(1, 1), Vector2(1, 1)
            clearRt.anchoredPosition = Vector2(-20, -225)
            clearRt.sizeDelta = Vector2(100, 35)
            local clearImg = clearBtnGo:AddComponent(typeof(Image))
            clearImg.color = Color(0.8, 0.2, 0.2, 1)
            local clearBtn = clearBtnGo:AddComponent(typeof(Button))
            local clearTxtGo = GameObject("ClearTxt")
            clearTxtGo.transform:SetParent(clearBtnGo.transform, false)
            local cTxtRt = clearTxtGo:AddComponent(typeof(RectTransform))
            cTxtRt.anchorMin, cTxtRt.anchorMax = Vector2(0, 0), Vector2(1, 1)
            cTxtRt.offsetMin, cTxtRt.offsetMax = Vector2(0, 0), Vector2(0, 0)
            local cTxt = clearTxtGo:AddComponent(typeof(Text))
            cTxt.text = "Xóa Token"
            cTxt.color, cTxt.fontSize, cTxt.alignment = Color.white, 14, TextAnchor.MiddleCenter
            if defaultFont then cTxt.font = defaultFont end

            clearBtn.onClick:AddListener(function()
                if _G.Mod_ClearAuthToken then
                    _G.Mod_ClearAuthToken()
                elseif _G.Mod_ClearAllPlayerPrefs then
            ...
            actRt.anchoredPosition = Vector2(0, 75)
            ...
            _G.CheckModAuth = function(tokenStr, isSilent)
                ...
                -- Xóa phần rỗng cuối cùng do dấu | ở đuôi
                ...
                _G.Mod_Config_Reincarnation_Primary = pMainTier or 8
                _G.Mod_Config_Reincarnation_Secondary = pSubTier or 7
                CS.UnityEngine.PlayerPrefs.SetInt("Mod_PrimaryTier", _G.Mod_Config_Reincarnation_Primary)
                CS.UnityEngine.PlayerPrefs.SetInt("Mod_SecondaryTier", _G.Mod_Config_Reincarnation_Secondary)
            ...
            -- Watermark in AuthPanel (Click to clear PlayerPrefs)
            ...
            authWmImg.color = Color(0, 0, 0, 0)

            local authWmTxtGo = GameObject("Text")
            authWmTxtGo.transform:SetParent(authWmGo.transform, false)
            local authWmTxtRt = authWmTxtGo:AddComponent(typeof(RectTransform))
            authWmTxtRt.anchorMin, authWmTxtRt.anchorMax = Vector2(0, 0), Vector2(1, 1)
            authWmTxtRt.sizeDelta = Vector2(0, 0)
            local authWmTxt = authWmTxtGo:AddComponent(typeof(Text))
            authWmTxt.raycastTarget = false
            ...
            authWmBtn.targetGraphic = authWmImg
        ...
        _G.ModCallbacks.OnToggleMenu = function()
            pcall(function()
                if _G.Mod_IsActive and _G.Mod_IsActive() then
        ...
        for _, slot in ipairs(fumoSlots) do
            for lv = 1, 7 do
                local key = "AutoPick_Fumo_" .. slot .. "_LV" .. lv
                if _G[key] == nil then
                    _G[key] = CS.UnityEngine.PlayerPrefs.GetInt("Mod_" .. key, 0) == 1
                end
            end
        ...
        local function CreateToggle(label, varName, xPos, yPos, customWidth, targetList, customParent, customHeight)
            ...
            tRt.sizeDelta = Vector2(customWidth or 260, customHeight or 35)
            ...
            btn.onClick:AddListener(function()
                ...
                if varName == "Mod_FindHoaLong_Enabled" then
                    if _G[varName] then
                        if _G.FloatingWordUtility and _G.FloatingWordUtility.QuickMsg then
                            _G.FloatingWordUtility.QuickMsg("BẮT ĐẦU TÌM HỎA LONG (DÙNG ĐÁ DỊCH CHUYỂN 0.5s/LẦN)...")
                        end
                        if _G.Mod_StartFindHoaLongLoop then
                            pcall(_G.Mod_StartFindHoaLongLoop)
                        end
                    else
                        if _G.Mod_StopTimer then
                            _G.Mod_StopTimer("Mod_FindHoaLongLoop")
                        end
                        if _G.FloatingWordUtility and _G.FloatingWordUtility.QuickMsg then
                            _G.FloatingWordUtility.QuickMsg("ĐÃ DỪNG TÌM HỎA LONG!")
                        end
                    end
                end
        ...
        -- =========================================================================
        -- [MOD FEATURE]: CỤM NÚT GỠ LAG & LÀM MƯỢT (TAB CƠ BẢN)
        -- Mô tả: Cung cấp nút Gỡ Lag (về neo Server) và nút Làm Mượt (tối ưu tài nguyên, reset timers, dọn GC)
        -- =========================================================================
        -- 1. NÚT GỠ LAG (Trái: x=340, w=160)
        ...
        uRt.sizeDelta = Vector2(160, 32)

        local uImg = unstickBtnGo:AddComponent(typeof(Image))
        uImg.color = Color(0.85, 0.38, 0.1, 1)
        ...
        -- 2. NÚT LÀM MƯỢT (Phải: x=510, w=160)
        local freshBtnGo = GameObject("FreshCleanBtn")
        freshBtnGo.transform:SetParent(panelGo.transform, false)
        table.insert(_G.CoBanUIList, freshBtnGo)

        local fRt = freshBtnGo:AddComponent(typeof(RectTransform))
        fRt.anchorMin, fRt.anchorMax, fRt.pivot = Vector2(0, 1), Vector2(0, 1), Vector2(0, 1)
        fRt.anchoredPosition = Vector2(510, -98)
        fRt.sizeDelta = Vector2(160, 32)

        local fImg = freshBtnGo:AddComponent(typeof(Image))
        fImg.color = Color(0.12, 0.58, 0.8, 1)
        fImg.raycastTarget = true

        local fTxtGo = GameObject("Text")
        fTxtGo.transform:SetParent(freshBtnGo.transform, false)
        local fTxtRt = fTxtGo:AddComponent(typeof(RectTransform))
        fTxtRt.anchorMin, fTxtRt.anchorMax, fTxtRt.sizeDelta = Vector2(0, 0), Vector2(1, 1), Vector2(0, 0)
        local fTxt = fTxtGo:AddComponent(typeof(Text))
        fTxt.raycastTarget = false
        fTxt.text = "LÀM MƯỢT"
        fTxt.color = Color.white
        fTxt.fontSize = 15
        fTxt.alignment = TextAnchor.MiddleCenter
        if defaultFont then fTxt.font = defaultFont end

        local fBtn = freshBtnGo:AddComponent(typeof(Button))
        fBtn.targetGraphic = fImg
        fBtn.onClick:AddListener(function()
            if _G.Mod_DoSystemFreshCleanup then
                _G.Mod_DoSystemFreshCleanup()
            else
                if _G.FloatingWordUtility and _G.FloatingWordUtility.QuickMsg then
                    _G.FloatingWordUtility.QuickMsg("[LÀM MƯỢT] Không tìm thấy hàm xử lý hệ thống!")
                end
            end
        end)
        ...
        -- =========================================================================
        -- [MOD FEATURE]: GIAO DIỆN TAB NHẶT ĐỒ SIÊU TỐC (AUTO LOOT UI & SCROLLVIEW)
        ...
        local function CreateAutoLootUI()
            ...
            titleRt.sizeDelta = Vector2(400, 25)
            local titleTxt = titleGo:AddComponent(typeof(Text))
            ...
            scrollRt.sizeDelta = Vector2(400, 335)
            ...
            -- Helper: Tạo Toggle nhỏ trong Content
            local function CreateSmallToggle(label, varName, xPos, yPos, width)
                local tGo = GameObject(varName .. "_Toggle")
                tGo.transform:SetParent(contentGo.transform, false)

                local tRt = tGo:AddComponent(typeof(RectTransform))
                tRt.anchorMin, tRt.anchorMax, tRt.pivot = Vector2(0, 1), Vector2(0, 1), Vector2(0, 1)
                tRt.anchoredPosition = Vector2(xPos, yPos)
                tRt.sizeDelta = Vector2(width or 40, 20)
            ...
            local function CreateBoneToggle(label, varName, xPos, yPos, width)
                ...
                tRt.anchorMin, tRt.anchorMax, tRt.pivot = Vector2(0, 1), Vector2(0, 1), Vector2(0, 1)
                tRt.anchoredPosition = Vector2(xPos, yPos)
                tRt.sizeDelta = Vector2(width, 26)
            ...
            local function CreateFumoLabel(text, x, y)
                local lbl = GameObject("FumoLbl_" .. text)
                lbl.transform:SetParent(contentGo.transform, false)
                local rt = lbl:AddComponent(typeof(RectTransform))
                rt.anchorMin, rt.anchorMax, rt.pivot = Vector2(0, 1), Vector2(0, 1), Vector2(0, 1)
                rt.anchoredPosition = Vector2(x, y)
                rt.sizeDelta = Vector2(56, 20)
                local txt = lbl:AddComponent(typeof(Text))
                txt.raycastTarget = false
                txt.text = text
                txt.color = Color(1, 1, 0.6, 1)
                txt.fontSize = 13
                txt.alignment = TextAnchor.MiddleLeft
                if defaultFont then txt.font = defaultFont end
            end

            local function CreateFumoToggle(label, varName, xPos, yPos, width)
                local tGo = GameObject(varName .. "_Toggle")
                tGo.transform:SetParent(contentGo.transform, false)
                ...
                tRt.anchorMin, tRt.anchorMax, tRt.pivot = Vector2(0, 1), Vector2(0, 1), Vector2(0, 1)
                tRt.anchoredPosition = Vector2(xPos, yPos)
                tRt.sizeDelta = Vector2(width or 38, 20)
                ...
                local function UpdateLabel()
                    if _G[varName] then
                        ...
                        bgImg.color = Color(0.28, 0.28, 0.28, 1)
                        txt.text = label
                        txt.color = Color(0.7, 0.7, 0.7, 1)
                    end
                end
            ...
            CreateToggle("TỰ ĐỘNG NHẶT", "AutoPick_Enabled", 10, curY, 180, nil, contentGo, 30)
            ...
            btnPa1Go.transform:SetParent(contentGo.transform, false)
            ...
            rtPa1.anchoredPosition = Vector2(200, curY)
            rtPa1.sizeDelta = Vector2(90, 30)
            ...
            btnPa2Go.transform:SetParent(contentGo.transform, false)
            ...
            rtPa2.anchoredPosition = Vector2(300, curY)
            rtPa2.sizeDelta = Vector2(90, 30)
            ...
            lvRt.anchorMin, lvRt.anchorMax, lvRt.pivot = Vector2(0, 1), Vector2(0, 1), Vector2(0, 1)
            lvRt.anchoredPosition = Vector2(10, curY)
            lvRt.sizeDelta = Vector2(200, 26)
            ...
            lMinusGo.transform:SetParent(contentGo.transform, false)
            local lmRt = lMinusGo:AddComponent(typeof(RectTransform))
            lmRt.anchorMin, lmRt.anchorMax, lmRt.pivot = Vector2(0, 1), Vector2(0, 1), Vector2(0, 1)
            lmRt.anchoredPosition = Vector2(225, curY)
            lmRt.sizeDelta = Vector2(78, 26)
            ...
            lmTxtRt.anchorMin, lmTxtRt.anchorMax = Vector2(0, 0), Vector2(1, 1)
            ...
            lPlusGo.transform:SetParent(contentGo.transform, false)
            local lpRt = lPlusGo:AddComponent(typeof(RectTransform))
            lpRt.anchorMin, lpRt.anchorMax, lpRt.pivot = Vector2(0, 1), Vector2(0, 1), Vector2(0, 1)
            lpRt.anchoredPosition = Vector2(312, curY)
            lpRt.sizeDelta = Vector2(78, 26)
            ...
            lpTxtRt.anchorMin, lpTxtRt.anchorMax = Vector2(0, 0), Vector2(1, 1)
            ...
            boneTitleRt.anchoredPosition = Vector2(0, curY)
            boneTitleRt.sizeDelta = Vector2(400, 20)
            ...
            boneTitleTxt.fontSize = 15
            boneTitleTxt.alignment = TextAnchor.MiddleCenter
            if defaultFont then boneTitleTxt.font = defaultFont end

            curY = curY - 24
            CreateBoneToggle("NHẶT HỒN", "AutoPick_Bone_Hon", 10, curY, 185)
            CreateBoneToggle("NHẶT CỐT", "AutoPick_Bone_Cot", 205, curY, 185)
            ...
            runeTitleRt.anchorMin, runeTitleRt.anchorMax, runeTitleRt.pivot = Vector2(0, 1), Vector2(0, 1), Vector2(0, 1)
            runeTitleRt.anchoredPosition = Vector2(0, curY)
            runeTitleRt.sizeDelta = Vector2(400, 20)
            local runeTitleTxt = runeTitleGo:AddComponent(typeof(Text))
            runeTitleTxt.raycastTarget = false
            runeTitleTxt.text = "[ LỰA CHỌN NHẶT PHÙ VĂN ]"
            runeTitleTxt.color = Color(1, 0.8, 0, 1)
            runeTitleTxt.fontSize = 15
            ...
            for _, row in ipairs(runeGrid) do
                -- Cột 1 (Bên trái: X = 10 -> 190)
                CreateRuneLabel(row.left.label, 10, curY)
                CreateSmallToggle("Lục", "AutoPick_Rune_" .. row.left.key .. "_Luc", 60, curY, 40)
                CreateSmallToggle("Lam", "AutoPick_Rune_" .. row.left.key .. "_Lam", 105, curY, 40)
                CreateSmallToggle("Đỏ", "AutoPick_Rune_" .. row.left.key .. "_Do", 150, curY, 40)

                -- Cột 2 (Bên phải: X = 210 -> 390)
                CreateRuneLabel(row.right.label, 210, curY)
                CreateSmallToggle("Lục", "AutoPick_Rune_" .. row.right.key .. "_Luc", 260, curY, 40)
                CreateSmallToggle("Lam", "AutoPick_Rune_" .. row.right.key .. "_Lam", 305, curY, 40)
                CreateSmallToggle("Đỏ", "AutoPick_Rune_" .. row.right.key .. "_Do", 350, curY, 40)
            ...
            fumoTitleRt.anchorMin, fumoTitleRt.anchorMax, fumoTitleRt.pivot = Vector2(0, 1), Vector2(0, 1), Vector2(0, 1)
            fumoTitleRt.anchoredPosition = Vector2(0, curY)
            fumoTitleRt.sizeDelta = Vector2(400, 20)
            local fumoTitleTxt = fumoTitleGo:AddComponent(typeof(Text))
            fumoTitleTxt.raycastTarget = false
            fumoTitleTxt.text = "[ LỰA CHỌN NHẶT PHỤ MA ]"
            fumoTitleTxt.color = Color(1, 0.8, 0, 1)
            fumoTitleTxt.fontSize = 15
            ...
            local fumoRows = {
                ...
                { label = "Tay",      key = "Tay" },
                { label = "Giày",     key = "Giay" },
                { label = "VK Chính", key = "VKChinh" },
                { label = "VK Phụ",   key = "VKPhu" },
            }

            for _, row in ipairs(fumoRows) do
                CreateFumoLabel(row.label, 10, curY)
                for lv = 1, 7 do
                    local btnX = 68 + (lv - 1) * 46
                    CreateFumoToggle("LV" .. lv, "AutoPick_Fumo_" .. row.key .. "_LV" .. lv, btnX, curY, 42)
                end
                curY = curY - 23
            end
            ...
            -- =========================================================================
            -- [MOD FEATURE]: KHỐI INFO KUNDUN BOSS CỐ ĐỊNH (FIXED AT BOTTOM OF LEFT COLUMN)
            -- Mô tả: Giữ cố định ở góc dưới cột trái (Y = -430 -> -570), không bị cuộn.
            -- =========================================================================
            local rightColX2 = 10
            local kundunY = -430
            ...
            sep2Rt.anchorMin, sep2Rt.anchorMax, sep2Rt.pivot = Vector2(0, 1), Vector2(0, 1), Vector2(0, 1)
            sep2Rt.anchoredPosition = Vector2(10, kundunY)
            sep2Rt.sizeDelta = Vector2(400, 14)
            ...
            kundunY = -448
            local titleGoKundun = GameObject("KundunTitle")
            titleGoKundun.transform:SetParent(panelGo.transform, false)
            table.insert(_G.NangCaoUIList, titleGoKundun)
            _G.KundunTitleGo = titleGoKundun
            local titleRtK = titleGoKundun:AddComponent(typeof(RectTransform))
            titleRtK.anchorMin, titleRtK.anchorMax, titleRtK.pivot = Vector2(0, 1), Vector2(0, 1), Vector2(0, 1)
            titleRtK.anchoredPosition = Vector2(10, kundunY)
            titleRtK.sizeDelta = Vector2(400, 20)
            local titleTxtK = titleGoKundun:AddComponent(typeof(Text))
            titleTxtK.raycastTarget = false
            titleTxtK.text = "[ INFO KUNDUN BOSS ]"
            titleTxtK.color = Color(1, 0.8, 0, 1)
            titleTxtK.fontSize = 16
            titleTxtK.alignment = TextAnchor.MiddleCenter
            if defaultFont then titleTxtK.font = defaultFont end

            local kundunTabY = -470
            ...
            sep3Rt.anchorMin, sep3Rt.anchorMax, sep3Rt.pivot = Vector2(0, 1), Vector2(0, 1), Vector2(0, 1)
            sep3Rt.anchoredPosition = Vector2(10, kundunY)
            sep3Rt.sizeDelta = Vector2(400, 14)
            ...
            for i = 1, 2 do
                ...
                local rt = rowGo:AddComponent(typeof(RectTransform))
                rt.anchorMin, rt.anchorMax, rt.pivot = Vector2(0, 1), Vector2(0, 1), Vector2(0, 1)
                rt.anchoredPosition = Vector2(20, kundunY)
                rt.sizeDelta = Vector2(360, 22)
                local txt = rowGo:AddComponent(typeof(Text))
                txt.raycastTarget = false
                txt.color = Color.white
                txt.fontSize = 15
            ...
            _G.ModUpdateKundunUI = function()
                pcall(function()
                    ...
                    if not kundunTiers or #kundunTiers == 0 then
                        kundunTiers = { "C7", "C8" }
                    end
                    ...
                    if _G.KundunUILabelPool then
                        for i = 1, 2 do
                            ...
                            if txt then
                                txt.gameObject:SetActive(_G.ModMainTab == "NANG_CAO")
                            end
                        end
                    end
            ...
            _G.Mod_AllUIUpdaters = _G.Mod_AllUIUpdaters or {}
            table.insert(_G.Mod_AllUIUpdaters, _G.ModUpdateKundunUI)
        end
        ...
        local function CreateAutoBossUI()
            ...
            -- Mô tả: Cột Trái (Auto Boss, Tự Vào Map Ẩn, Nhớ Skill Map Ẩn) - Cột Phải (Tọa Độ Train, % HP Bỏ Boss KS)
            -- =========================================================================

            -- CỘT TRÁI - HÀNG 1: Master Toggle AUTO BOSS (y = -68)
            ...
            mtRt.anchoredPosition = Vector2(startX, -68)
            mtRt.sizeDelta = Vector2(200, 30)
            ...
            -- CỘT TRÁI - HÀNG 2: TỰ VÀO MAP ẨN Toggle (y = -102)
            ...
            htRt.anchoredPosition = Vector2(startX, -102)
            htRt.sizeDelta = Vector2(200, 30)
            ...
            -- CỘT TRÁI - HÀNG 3: NÚT NHỚ SKILL MAP ẨN (y = -136)
            ...
            ssRt.anchoredPosition = Vector2(startX, -136)
            ssRt.sizeDelta = Vector2(200, 30)
            ...
            lblRt.anchoredPosition = Vector2(230, -68)
            ...
            trainRt.anchoredPosition = Vector2(230, -86)
            trainRt.sizeDelta = Vector2(105, 28)
            ...
            getPosRt.anchoredPosition = Vector2(340, -86)
            getPosRt.sizeDelta = Vector2(110, 28)
            ...
            -- CỘT PHẢI - HÀNG 2 & 3: % HP BỎ QUA BOSS (KHI BỊ KS)
            ...
            skipLblRt.anchoredPosition = Vector2(230, -120)
            ...
            -- Display value box (x=230, w=110, h=28)
            ...
            skipValRt.anchoredPosition = Vector2(230, -138)
            skipValRt.sizeDelta = Vector2(110, 28)
            ...
            local function createSkipHpBtn(name, posX, w, btnText, btnColor)
                ...
                bRt.anchoredPosition = Vector2(posX, -138)
                bRt.sizeDelta = Vector2(w, 28)
            ...
            local function UpdateTierTabs()
                ...
                for tIdx, tag in ipairs(currentTiers) do
                    ...
                    if tBtn then
                        ...
                        if rt then
                            rt.anchoredPosition = Vector2(startX + (tIdx - 1) * 120, gridStartY + 35)
                        end
        ...
        local function CreateAdminUI()
            ...
            local function Base64Encode(data)
                if not data or data == "" then return "" end
                local status, res = pcall(function()
                    local bytes = CS.System.Text.Encoding.UTF8:GetBytes(data)
                ...
                for i = 1, #data do
                    ...
                    for j = 8, 1, -1 do
                        table.insert(bitTable, (b % 2 ^ j - b % 2 ^ (j - 1) > 0 and '1' or '0'))
                    end
                end
                while (#bitTable % 6 ~= 0) do
                    table.insert(bitTable, '0')
                end
                local bitStr = table.concat(bitTable)
                local result = {}
                for i = 1, #bitStr, 6 do
                    local chunk = string.sub(bitStr, i, i + 5)
                    local c = 0
                    for j = 1, 6 do
                        if string.sub(chunk, j, j) == '1' then
                            c = c + 2 ^ (6 - j)
                    ...
                    table.insert(result, string.sub(b64chars, c + 1, c + 1))
                end
                local padCount = (3 - (#data % 3)) % 3
                if padCount == 1 then
                    table.insert(result, '=')
                elseif padCount == 2 then
                    table.insert(result, '=')
                    table.insert(result, '=')
                end
                return table.concat(result)
        ...
        -- Watermark (Tab Cơ Bản - Click để xóa Token & Reset Auth)
        ...
        wmRt.sizeDelta = Vector2(160, 25)

        local wmImg = watermarkGo:AddComponent(typeof(Image))
        wmImg.color = Color(0, 0, 0, 0)

        local wmTxtGo = GameObject("Text")
        wmTxtGo.transform:SetParent(watermarkGo.transform, false)
        local wmTxtRt = wmTxtGo:AddComponent(typeof(RectTransform))
        wmTxtRt.anchorMin, wmTxtRt.anchorMax = Vector2(0, 0), Vector2(1, 1)
        ...
        wmTxt.color = Color(0.215, 0.490, 0.133, 0.9)
        wmTxt.fontSize = 15
            ...
            local function ExecutePickupCommon(dropItemData, startTime, interceptTime, logPrefix)
                local ok, err = pcall(function()
                    ...
                    if isAdminBurst and logPrefix ~= "KTĐ" then
                        ...
                        -- 1. BẮN 3 GÓI TIỀN TRẢM TỨC THÌ 0ms (Nếu nằm trong tầm 1.5-2 ô quanh người là ăn luôn)
                        if _G.PickupManager and _G.PickupManager.ReqPickUpMapItem and dropItemData.id then
                            _G.PickupManager.ReqPickUpMapItem(dropItemData.id)
                            _G.PickupManager.ReqPickUpMapItem(dropItemData.id)
                            _G.PickupManager.ReqPickUpMapItem(dropItemData.id)
                        end

                        -- 2. TÍNH KHOẢNG CÁCH TỪ NHÂN VẬT ĐẾN ITEM
                        local me = _G.RoleManager and _G.RoleManager.me
                        local meCoord = me and (me.serverCoord or me.cellPos or me.curPos or (me.data and (me.data.serverCoord or me.data.cellPos or me.data)))
                        local meX = meCoord and (meCoord.x or meCoord.X) or 0
                        local meY = meCoord and (meCoord.y or meCoord.Y) or 0
                        local dist = (meX > 0 and meY > 0 and itemX > 0 and itemY > 0) and math.max(math.abs(meX - itemX), math.abs(meY - itemY)) or 999

                        -- 3. NẾU CỰ LY > 1.5 Ô: GIẢI PHÓNG TRẠNG THÁI KHÓA & DI CHUYỂN NGAY TỚI ITEM
                        if dist > 1.5 and me and itemX > 0 and itemY > 0 then
                            pcall(function()
                                if me.StopMoveImmediate then me:StopMoveImmediate() end
                                if me.MoveCloseAutoFight then me:MoveCloseAutoFight() end
                                if me.SetAutoFight then me:SetAutoFight("None") end
                                ...
                                if me.MoveTo then
                                    me:MoveTo({ x = itemX, y = itemY }, 0)
                                end
                            end)
                        end

                        -- 4. BẮN TIẾP 5 GÓI BỒI NGAY SAU KHI PHÁT LỆNH DI CHUYỂN
                        if _G.PickupManager and _G.PickupManager.ReqPickUpMapItem and dropItemData.id then
                            for i = 1, 5 do
                                _G.PickupManager.ReqPickUpMapItem(dropItemData.id)
                            end
                        ...
                        -- 5. NẠP VÀO HÀNG ĐỢI SPAM DUY TRÌ MỖI FRAME (Cho đến khi item biến mất)
                        ...
                        -- 6. GHI LOG ĐẦY ĐỦ CHI TIẾT TƯƠNG ĐƯƠNG PA1 & PA2
                        ...
                        if _G.WriteLog then
                            ...
                            _G.WriteLog(string.format(
                                "[%s] Nhặt ADMIN-BURST [3-Pre+Move+5-Post] (Time: %s | Xử: %dms): Type=%s, Obj=%s | NV=(%s,%s), Item=(%s,%s), KC=%.1f | Kun=(%s,%s), KunKC=%s",
                                logPrefix, tostring(interceptTime), costMs, tostring(itemTypeId),
                                tostring(objId), tostring(meX), tostring(meY), tostring(itemX), tostring(itemY), dist, tostring(kunX), tostring(kunY), tostring(kunDist)))
                        end
                        return
                    end
...
-- =========================================================================
-- [MOD FEATURE]: TỰ ĐỘNG TÌM HỎA LONG BẰNG ĐÁ DỊCH CHUYỂN (AUTO FIND HOA LONG)
-- Mô tả: Timer tần suất 0.5s/lần sử dụng Đá Dịch Chuyển (20000022) nhảy ngẫu nhiên trên bản đồ.
--        Mỗi lần quét phạm vi 15 ô xung quanh, nếu phát hiện Hỏa Long / Vua Hỏa Long (100112, 500301)
--        thì dừng nhảy, khóa mục tiêu và in QuickMsg tọa độ ra màn hình.
-- =========================================================================
_G.Mod_FindHoaLong_Enabled = false
